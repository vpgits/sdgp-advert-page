    ...
    <section  className="w-full py-12 px-4 my-36 mt-44">
            ...
            <div className="">
              ...
              <div className="lg:flex lg:flex-auto lg:flex-row">
                <div className="flex flex-auto flex-row items-center mr-36">
                  <Image
                    src={Phone}
                    alt="Phone Image"
                    className=" w-3/4" // Adjust the width and height as needed
                  />
              ...
              <div className="lg:flex lg:flex-auto lg:flex-row mt-36">
                <div className="flex flex-auto flex-row justify-center lg:mt-36">
              ...
              <div className="lg:flex lg:flex-auto lg:flex-row lg:mt-36">
                <div className="flex flex-auto flex-row items-center">
                  ...
                  />
                  <div className=" my-3 text-center lg:ml-10">
                    <h1 className="text-2xl font-bold">Engage with Quizzifyme Chat</h1>
